...
EXPORT_SYMBOL_GPL(nvmet_addr_adrfam_show);
...
EXPORT_SYMBOL_GPL(nvmet_addr_adrfam_store);
...
EXPORT_SYMBOL_GPL(nvmet_addr_portid_show);
...
EXPORT_SYMBOL_GPL(nvmet_addr_portid_store);
...
EXPORT_SYMBOL_GPL(nvmet_addr_traddr_show);
...
EXPORT_SYMBOL_GPL(nvmet_addr_traddr_store);
...
EXPORT_SYMBOL_GPL(nvmet_addr_treq_show);
...
EXPORT_SYMBOL_GPL(nvmet_addr_treq_store);
...
EXPORT_SYMBOL_GPL(nvmet_addr_trsvcid_show);
...
EXPORT_SYMBOL_GPL(nvmet_addr_trsvcid_store);
...
EXPORT_SYMBOL_GPL(nvmet_addr_trtype_show);
...
EXPORT_SYMBOL_GPL(nvmet_port_init_tsas_rdma);
...
EXPORT_SYMBOL_GPL(nvmet_port_init_tsas_loop);
...
EXPORT_SYMBOL_GPL(nvmet_addr_trtype_store);
/*
...
EXPORT_SYMBOL_GPL(nvmet_ns_device_path_show);
...
EXPORT_SYMBOL_GPL(nvmet_ns_device_path_store);

static ssize_t nvmet_ns_device_nguid_show(struct config_item *item, char *page)
{
	return sprintf(page, "%pUb\n", &to_nvmet_ns(item)->nguid);
}
EXPORT_SYMBOL_GPL(nvmet_ns_device_nguid_show);
...
EXPORT_SYMBOL_GPL(nvmet_ns_device_nguid_store);

static ssize_t nvmet_ns_enable_show(struct config_item *item, char *page)
{
	return sprintf(page, "%d\n", to_nvmet_ns(item)->enabled);
}
EXPORT_SYMBOL_GPL(nvmet_ns_enable_show);
...
EXPORT_SYMBOL_GPL(nvmet_ns_enable_store);
...
EXPORT_SYMBOL_GPL(nvmet_ns_attrs);
...
EXPORT_SYMBOL_GPL(nvmet_ns_release);

static struct configfs_item_operations nvmet_ns_item_ops = {
	.release		= nvmet_ns_release,
};
EXPORT_SYMBOL_GPL(nvmet_ns_item_ops);
...
EXPORT_SYMBOL_GPL(nvmet_ns_type);
...
EXPORT_SYMBOL_GPL(nvmet_port_subsys_allow_link);
...
EXPORT_SYMBOL_GPL(nvmet_port_subsys_drop_link);

static struct configfs_item_operations nvmet_port_subsys_item_ops = {
	.allow_link		= nvmet_port_subsys_allow_link,
	.drop_link		= nvmet_port_subsys_drop_link,
};
EXPORT_SYMBOL_GPL(nvmet_port_subsys_item_ops);

static struct config_item_type nvmet_port_subsys_type = {
	.ct_item_ops		= &nvmet_port_subsys_item_ops,
	.ct_owner		= THIS_MODULE,
};
EXPORT_SYMBOL_GPL(nvmet_port_subsys_type);
...
EXPORT_SYMBOL_GPL(nvmet_allowed_hosts_allow_link);
...
EXPORT_SYMBOL_GPL(nvmet_allowed_hosts_drop_link);

static struct configfs_item_operations nvmet_allowed_hosts_item_ops = {
	.allow_link		= nvmet_allowed_hosts_allow_link,
	.drop_link		= nvmet_allowed_hosts_drop_link,
};
EXPORT_SYMBOL_GPL(nvmet_allowed_hosts_item_ops);

static struct config_item_type nvmet_allowed_hosts_type = {
	.ct_item_ops		= &nvmet_allowed_hosts_item_ops,
	.ct_owner		= THIS_MODULE,
};
EXPORT_SYMBOL_GPL(nvmet_allowed_hosts_type);
...
EXPORT_SYMBOL_GPL(nvmet_subsys_attr_allow_any_host_show);
...
EXPORT_SYMBOL_GPL(nvmet_subsys_attr_allow_any_host_store);

static struct configfs_attribute *nvmet_subsys_attrs[] = {
	&nvmet_subsys_attr_attr_allow_any_host,
	NULL,
};
EXPORT_SYMBOL_GPL(nvmet_subsys_attrs);
...
EXPORT_SYMBOL_GPL(nvmet_subsys_release);

static struct configfs_item_operations nvmet_subsys_item_ops = {
	.release		= nvmet_subsys_release,
};
EXPORT_SYMBOL_GPL(nvmet_subsys_item_ops);
...
EXPORT_SYMBOL_GPL(nvmet_subsys_type);
...
EXPORT_SYMBOL_GPL(nvmet_referral_enable_show);
...
EXPORT_SYMBOL_GPL(nvmet_referral_enable_store);
...
EXPORT_SYMBOL_GPL(nvmet_referral_attrs);
...
EXPORT_SYMBOL_GPL(nvmet_referral_release);

static struct configfs_item_operations nvmet_referral_item_ops = {
	.release	= nvmet_referral_release,
};
EXPORT_SYMBOL_GPL(nvmet_referral_item_ops);
...
EXPORT_SYMBOL_GPL(nvmet_referral_type);
...
EXPORT_SYMBOL_GPL(nvmet_referral_make);

static struct configfs_group_operations nvmet_referral_group_ops = {
	.make_group		= nvmet_referral_make,
};
EXPORT_SYMBOL_GPL(nvmet_referral_group_ops);

static struct config_item_type nvmet_referrals_type = {
	.ct_owner	= THIS_MODULE,
	.ct_group_ops	= &nvmet_referral_group_ops,
};
EXPORT_SYMBOL_GPL(nvmet_referrals_type);
...
EXPORT_SYMBOL_GPL(nvmet_port_release);
...
EXPORT_SYMBOL_GPL(nvmet_port_attrs);

static struct configfs_item_operations nvmet_port_item_ops = {
	.release		= nvmet_port_release,
};
EXPORT_SYMBOL_GPL(nvmet_port_item_ops);
...
EXPORT_SYMBOL_GPL(nvmet_port_type);
...
EXPORT_SYMBOL_GPL(nvmet_ports_make);

static struct configfs_group_operations nvmet_ports_group_ops = {
	.make_group		= nvmet_ports_make,
};
EXPORT_SYMBOL_GPL(nvmet_ports_group_ops);

static struct config_item_type nvmet_ports_type = {
	.ct_group_ops		= &nvmet_ports_group_ops,
	.ct_owner		= THIS_MODULE,
};
EXPORT_SYMBOL_GPL(nvmet_ports_type);

static struct config_group nvmet_subsystems_group;
EXPORT_SYMBOL_GPL(nvmet_subsystems_group);
static struct config_group nvmet_ports_group;
EXPORT_SYMBOL_GPL(nvmet_ports_group);
...
EXPORT_SYMBOL_GPL(nvmet_host_release);

static struct configfs_item_operations nvmet_host_item_ops = {
	.release		= nvmet_host_release,
};
EXPORT_SYMBOL_GPL(nvmet_host_item_ops);

static struct config_item_type nvmet_host_type = {
	.ct_item_ops		= &nvmet_host_item_ops,
	.ct_owner		= THIS_MODULE,
};
EXPORT_SYMBOL_GPL(nvmet_host_type);
...
EXPORT_SYMBOL_GPL(nvmet_hosts_make_group);

static struct configfs_group_operations nvmet_hosts_group_ops = {
	.make_group		= nvmet_hosts_make_group,
};
EXPORT_SYMBOL_GPL(nvmet_hosts_group_ops);

static struct config_item_type nvmet_hosts_type = {
	.ct_group_ops		= &nvmet_hosts_group_ops,
	.ct_owner		= THIS_MODULE,
};
EXPORT_SYMBOL_GPL(nvmet_hosts_type);

static struct config_group nvmet_hosts_group;
EXPORT_SYMBOL_GPL(nvmet_hosts_group);

static struct config_item_type nvmet_root_type = {
	.ct_owner		= THIS_MODULE,
};
EXPORT_SYMBOL_GPL(nvmet_root_type);
...
EXPORT_SYMBOL_GPL(nvmet_configfs_subsystem);
...
EXPORT_SYMBOL_GPL(nvmet_init_configfs);

void __exit nvmet_exit_configfs(void)
{
	configfs_unregister_subsystem(&nvmet_configfs_subsystem);
}
EXPORT_SYMBOL_GPL(nvmet_exit_configfs);
