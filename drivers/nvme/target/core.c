...
EXPORT_SYMBOL_GPL(nvmet_copy_to_sgl);
...
EXPORT_SYMBOL_GPL(nvmet_copy_from_sgl);

static u32 nvmet_async_event_result(struct nvmet_async_event *aen)
{
	return aen->event_type | (aen->event_info << 8) | (aen->log_page << 16);
}
EXPORT_SYMBOL_GPL(nvmet_async_event_result);
...
EXPORT_SYMBOL_GPL(nvmet_async_events_free);
...
EXPORT_SYMBOL_GPL(nvmet_async_event_work);
...
EXPORT_SYMBOL_GPL(nvmet_enable_port);
...
EXPORT_SYMBOL_GPL(nvmet_disable_port);
...
EXPORT_SYMBOL_GPL(nvmet_keep_alive_timer);
...
EXPORT_SYMBOL_GPL(nvmet_start_keep_alive_timer);
...
EXPORT_SYMBOL_GPL(__nvmet_find_namespace);
...
EXPORT_SYMBOL_GPL(nvmet_find_namespace);
...
EXPORT_SYMBOL_GPL(nvmet_destroy_namespace);

void nvmet_put_namespace(struct nvmet_ns *ns)
{
	percpu_ref_put(&ns->ref);
}
EXPORT_SYMBOL_GPL(nvmet_put_namespace);
...
EXPORT_SYMBOL_GPL(__nvmet_req_complete);
...
EXPORT_SYMBOL_GPL(nvmet_sq_setup);
...
EXPORT_SYMBOL_GPL(nvmet_sq_free);
...
EXPORT_SYMBOL_GPL(nvmet_cc_en);

static inline u8 nvmet_cc_css(u32 cc)
{
	return (cc >> 4) & 0x7;
}
EXPORT_SYMBOL_GPL(nvmet_cc_css);

static inline u8 nvmet_cc_mps(u32 cc)
{
	return (cc >> 7) & 0xf;
}
EXPORT_SYMBOL_GPL(nvmet_cc_mps);

static inline u8 nvmet_cc_ams(u32 cc)
{
	return (cc >> 11) & 0x7;
}
EXPORT_SYMBOL_GPL(nvmet_cc_ams);

static inline u8 nvmet_cc_shn(u32 cc)
{
	return (cc >> 14) & 0x3;
}
EXPORT_SYMBOL_GPL(nvmet_cc_shn);

static inline u8 nvmet_cc_iosqes(u32 cc)
{
	return (cc >> 16) & 0xf;
}
EXPORT_SYMBOL_GPL(nvmet_cc_iosqes);

static inline u8 nvmet_cc_iocqes(u32 cc)
{
	return (cc >> 20) & 0xf;
}
EXPORT_SYMBOL_GPL(nvmet_cc_iocqes);
...
EXPORT_SYMBOL_GPL(nvmet_start_ctrl);
...
EXPORT_SYMBOL_GPL(nvmet_clear_ctrl);
...
EXPORT_SYMBOL_GPL(nvmet_init_cap);
...
EXPORT_SYMBOL_GPL(__nvmet_host_allowed);
...
EXPORT_SYMBOL_GPL(nvmet_host_discovery_allowed);
...
EXPORT_SYMBOL_GPL(nvmet_host_allowed);
...
EXPORT_SYMBOL_GPL(nvmet_ctrl_free);
...
EXPORT_SYMBOL_GPL(nvmet_fatal_error_handler);
...
EXPORT_SYMBOL_GPL(nvmet_subsys_free);
